...
CPP_SRCS += \
../src/modulos/9-Display/09C-display/display7Segmentos.cpp 

CPP_DEPS += \
./src/modulos/9-Display/09C-display/display7Segmentos.d 

OBJS += \
./src/modulos/9-Display/09C-display/display7Segmentos.o 


# Each subdirectory must supply rules for building sources it contributes
src/modulos/9-Display/09C-display/%.o: ../src/modulos/9-Display/09C-display/%.cpp src/modulos/9-Display/09C-display/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-modulos-2f-9-2d-Display-2f-09C-2d-display

clean-src-2f-modulos-2f-9-2d-Display-2f-09C-2d-display:
	-$(RM) ./src/modulos/9-Display/09C-display/display7Segmentos.d ./src/modulos/9-Display/09C-display/display7Segmentos.o

.PHONY: clean-src-2f-modulos-2f-9-2d-Display-2f-09C-2d-display
